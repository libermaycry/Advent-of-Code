...
import static advent_of_code.y2022.day2.RockPaperScissors_Part1.Outcome.*;
import static advent_of_code.y2022.day2.RockPaperScissors_Part1.Shape.*;

public class RockPaperScissors_Part1 {

    public static void main(String[] args) {
        new RockPaperScissors_Part1().run();
    }
    ...
    private List<Round> getRounds(List<String> lines) {
        ...
        for (String line : lines) {
            ...
            Shape opponentPlay = null, responsePlay = null;

            String[] split = line.split(" ");
            String first = split[0];
            String second = split[1];
            if(first.equals("A")) opponentPlay = ROCK;
            if(first.equals("B")) opponentPlay = PAPER;
            if(first.equals("C")) opponentPlay = SCISSORS;

            if(second.equals("X")) responsePlay = ROCK;
            if(second.equals("Y")) responsePlay = PAPER;
            if(second.equals("Z")) responsePlay = SCISSORS;
