...
public class ReindeerMazeResolver2 extends MazeResolverAllCheapest {

    public ReindeerMazeResolver2(Matrix maze, char floor, char start, char exit, char wall, Orientation startOrientation) {
